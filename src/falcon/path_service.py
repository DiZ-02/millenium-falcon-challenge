...
class PathService:
    ...
    def add_graph(self, routes: list[Route]):
        self.graph.clear()
        for route in routes:
        ...
        print(f"{len(routes)} edges added.")

    def add_weights(self, communication: Communication):
        ...
        print(f"{len(communication.bounty_hunters)} weights added.")
