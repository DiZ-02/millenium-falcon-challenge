...
def get_version(dist: str = "millenium-falcon-challenge") -> str:
...
def get_debug_info() -> Environment:
    ...
    packages = ["millenium-falcon-challenge"]
    variables = ["PYTHONPATH", *[var for var in os.environ if var.startswith("MILLENIUM_FALCON_CHALLENGE")]]
    return Environment(
